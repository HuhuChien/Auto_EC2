...
const BackendEditEC2Form = ({theIndex,demand_default,server_name_default,os_default,disk_default,dynamic_default,resource_default,subnet_default,check_default,demand_ChangeHandler,os_ChangeHandler,instance_type_ChangeHandler,handle_Update,
  cancel,ec2_Name_ChangeHandler,ip_ChangeHandler,disk_ChangeHandler,subnet_ChangeHandler,handle_Update_DB,subnet,counter,counter2,handle_Add_Disk,handle_Remove_Disk,handle_Remove_Disk2,handleChange,handleChange2,ghost,response}) => {
      ...
      <div className="modal fade form_modal" data-keyboard="false" data-backdrop="static" id="form_modal_edit_backend" tabIndex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
            ...
            <div className="modal-dialog modal-lg">
              ...
              <button data-dismiss="modal" className="close" type="button" onClick={() => cancel()}>
                  ...
                  <form className="form wrapper" id="the_form">
                  <div className="form-row">
                    ...
                    {  
                      ...
                      receiveData.length > 0 && receiveData[theIndex ? theIndex : 0].extra_disks.map((c, index) => {
                        return <div className='form-row the-form-row' id={`dynamicc${index}`} key={index}>
                            <div className="form-group the_form-group dynamic_disk" >  
                                    <button onClick={(e) => handle_Remove_Disk(e,index)} className="remove_disk" id={`dynamicc${index}`}>移除硬碟</button>
                                    <label>主機硬碟</label>
                                    <div className='d-flex'>
            ...
            
                   {
                        counter2.map((c, index) => {
                            let start_point = receiveData[theIndex].extra_disks.length + 2
                          ...
                          {(subnet === 'subnet-931d95e4' ||  subnet === 'subnet-6a00a333') &&
                          <div className="form-row">
                            <div className="form-group">
